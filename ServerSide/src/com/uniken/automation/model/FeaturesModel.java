...
public class FeaturesModel extends BaseModel {
	public void getFeature(FeatureBean bean) throws Exception
	{
		
					execute("insert into features (feature_name,feature_target) values ('" + bean.getFeature_name() + "','" + bean.getFeature_target() +  "')" );
