...
/**
 * Servlet implementation class FailedFeaturesSummaryController
 */
@WebServlet("/getFailuresByFeatures.htm")
public class FailedFeaturesSummaryController extends HttpServlet {
     ...
     */
    public FailedFeaturesSummaryController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			resp = new TestJobModel().getFailedCountByFeature();
		}
		catch(Exception e)
		{
			e.printStackTrace();
